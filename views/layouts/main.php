    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Invest Tracker</strong> is packed with useful features, components and more to manage your finance assets like a pro</p>
                <a class="btn btn-success btn-sm" href="https://startbootstrap.com/theme/sb-admin-pro">Sign in!</a>
            </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo yii\helpers\Url::to(['site/login'])?>">Login</a>
                        <a class="collapse-item" href="<?php echo yii\helpers\Url::to(['site/signup'])?>">Signup</a>
                        <a class="collapse-item" href="<?php echo yii\helpers\Url::to(['site/forgot-password'])?>">Forgot Password</a>
                        <a class="collapse-item" href="<?php echo yii\helpers\Url::to(['site/welcome'])?>">Welcome</a>
